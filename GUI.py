...
c = Label(frame, text="Medical Disease Prediction using ML", fg='blue4')
...
kk = Button(frame, text='Result', command=main.prediction, bg='red', fg='white', activebackground='red')
...
tt = Label(frame, text='N.B: Use 3 symptoms for better results')
